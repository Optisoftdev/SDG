        ...
        $('body').on('change', '#national', function() {
            ...
            if ($(this).val() == "Nigeria") {
                ...
                $(".stateelement").css("display", ""); //unhide the state field
                $(".lgaelement").css("display", ""); //unhide the LGA field
                $(".state2").css("display", "block"); 
                $(".lga2").css("display", "block"); 
                ...
                $(".stateelement").css("display", "none"); //hide the state field
                $(".lgaelement").css("display", "none"); //hide the LGA element
                $(".state2").css("display", "none"); 
                $(".lga2").css("display", "none"); 
                
                state.children().each(function(ing, el) {
                    if (ing > 0) {
                        $(this).remove();
                    }
                });
